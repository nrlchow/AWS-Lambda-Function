...
function getShoeName(shoeType) {
    retun faker.company.catchPhraseNoun() + "" + faker.company.catchPhraseDescriptor() + 
        "" + shoeType;
...
function getShoeDescription(shoeType) {
    return "A(n)" + faker.commerce.productAdjective()+"," + faker.commerce.productAdjective() + 
        " "+ shoeType + "made from the finest" + faker.commerce.productMaterial()+ "desined for the " + faker.company.bsBuzz() + "individual!"
